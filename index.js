...
getTodayWeather().then(data => {
    ...
    todayTemp.innerHTML = `${data.temperature.data[1].value} °C`
...
getResult().then(data => {
    ...
    week1Date.innerHTML = `${data.weatherForecast[0].forecastDate.slice(4,6)}月${data.weatherForecast[0].forecastDate.slice(6)}日 ${data.weatherForecast[0].week}`
    week2Date.innerHTML = `${data.weatherForecast[1].forecastDate.slice(4,6)}月${data.weatherForecast[1].forecastDate.slice(6)}日 ${data.weatherForecast[1].week}`
    week3Date.innerHTML = `${data.weatherForecast[2].forecastDate.slice(4,6)}月${data.weatherForecast[2].forecastDate.slice(6)}日 ${data.weatherForecast[2].week}`
    week4Date.innerHTML = `${data.weatherForecast[3].forecastDate.slice(4,6)}月${data.weatherForecast[3].forecastDate.slice(6)}日 ${data.weatherForecast[3].week}`
